...
using Reqnroll;
namespace Enterprise.Tests.Features
{
    ...
    public partial class UserAuthenticationFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "features", "User Authentication", "  As a registered user\r\n  I want to log into the application\r\n  So that I can acc" +
                "ess my dashboard", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
#line 9
    await testRunner.WhenAsync("I enter credentials \"student\" and \"Password123\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 10
    await testRunner.ThenAsync("I should see the success header \"Logged In Successfully\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
